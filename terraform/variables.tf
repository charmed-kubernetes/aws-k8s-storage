...
variable "config" {
  description = "Application config. Details about available options can be found at https://charmhub.io/aws-k8s-storage/configurations."
  type        = map(string)
  default     = {}
}
